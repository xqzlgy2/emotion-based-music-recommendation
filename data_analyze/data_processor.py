...
if __name__ == '__main__':
    # million song subset is from: http://millionsongdataset.com/pages/getting-dataset/index.html
    # label file 'msd_tagtraum_cd2.cls' is from: https://www.tagtraum.com/msd_genre_datasets.html
    # spority features folder is from: https://www.kaggle.com/yamaerenay/spotify-dataset-19212020-160k-tracks?select=data.csv
    # subset could also be replaced with full dataset on AWS
